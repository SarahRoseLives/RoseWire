...
class LoginPanelMobile extends StatefulWidget {
  final void Function(String nickname, String keyPath) onLogin;
  const LoginPanelMobile({super.key, required this.onLogin});

  @override
  State<LoginPanelMobile> createState() => _LoginPanelMobileState();
}

class _LoginPanelMobileState extends State<LoginPanelMobile> {
  bool _loading = true;
  ...
  Future<void> _createNewKeyAndNick() async {
    ...
    try {
      // Key generation logic (identical to desktop)
      ...
      body: Center(
        child: SingleChildScrollView( // Added for smaller screens
          ...
          child: Card(
            ...
            child: Container(
              width: 400, // Max width for consistency
                        ...
                        if (_keyNickPairs.isNotEmpty && !_creatingNew) ...[
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: _loading
                                ? null
                                : (val) {
                                    final selected = _keyNickPairs.firstWhere(
                                        (pair) => pair['nickname'] == val);
                                    setState(() {
                                      _selectedNick = val;
